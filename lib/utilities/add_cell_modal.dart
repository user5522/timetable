...
class AddCellModal extends StatefulWidget {
  ...
  final void Function(
          String newCellLabel, String newCellLocation, Color newCellColor)?
      onCellSaved;
...
class AddCellModalState extends State<AddCellModal> {
  ...
  ColorLabel findColorLabelFromColor(Color color) {
    final matchingColorLabel = ColorLabel.values
        .firstWhere((colorLabel) => colorLabel.color == color, orElse: () {

...
import 'package:timetable/features/subjects/widgets/color_picker.dart';
import 'package:timetable/features/subjects/widgets/preset_colors.dart';
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: <Widget>[
            ...
            Tab(icon: const Icon(Icons.colorize), text: "custom".tr()),
          ],
        ),
      ),
      body: TabBarView(
        ...
        children: <Widget>[
          Center(
            child: PresetColorsScreen(color: widget.color, colors: colors),
          ),
          Center(child: ColorPickerScreen(color: widget.color)),
        ],
      ),
    );
  }

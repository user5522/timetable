...
import 'package:timetable/features/subjects/widgets/subjects_list.dart';
import 'package:timetable/shared/widgets/list_item_group.dart';
import 'package:timetable/core/constants/basic_subject.dart';
      ...
      children: [
        ...
        ListItem(
          title: TextFormField(
            ...
            onChanged: (value) => widget.location.value = value,
          ),
        ),
      ],
    );
